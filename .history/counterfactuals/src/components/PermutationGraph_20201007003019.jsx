    ...
    <div className="container permutation-container">
      ...
      <div className="row d-flex justify-content-center">
        <div className="col-10 text-center">
          <h6 className="text-secondary p-1">
            The graph shows the % change per feature and the effect it has on
            target - represented by striped area if % change is larger than 0.
          </h6>
        </div>
      </div>
