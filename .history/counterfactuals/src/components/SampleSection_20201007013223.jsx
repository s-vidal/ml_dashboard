  ...
  return (
    <div className="container p-0 mr-5 ">
      <div className="sample-container p-4 pl-5 pr-5 m-0 pt-5">
        ...
        <div className="row">
          <p className="text-secondary mb-5 ml-3">
            The point of interest in the dataset with its features and predicted
            value
          </p>
        </div>
        ...
        {sampleData["target"].map((target, index) => (
          <div className="row mt-3" key={index}>
            <h6 className="mr-3 mt-5 ml-3">Predicted value</h6>
            <h6 className="pl-3 pr-2 p-1 mt-5 target-key">
              {Object.keys(target)} :
            </h6>
            <h6 className="pl-2 pr-3 p-1 mt-5 target-val">
