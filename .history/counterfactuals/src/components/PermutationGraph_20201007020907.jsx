...
const PermutationGraph = ({featureNames, dataHandler}) => {
  ...
  return (
    <div className="container permutation-container pb-3 shadow">
      ...
      <div className="row d-flex justify-content-center checkbox-bg">
        <h6 className="text-secondary pt-5 ">Select by feature:</h6>
        {featureNames["featuresNames"].map((feature, index) => (
          <span key={index} className="d-flex pt-5 pl-4 pr-4">
            <input
              className="mr-2 pt-1"
              type="checkbox"
              id={feature}
