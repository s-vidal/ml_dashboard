  ...
  return (
    <div className="container p-0">
      <div className="sample-container p-4 pl-5 pr-5 m-0">
        <div className="row">
          <h5 className="mb-3">Sample Data</h5>
        </div>
        <div className="row">
        ...
        {sampleData["target"].map((target, index) => (
          <div className="row mt-3" key={index}>
            ...
            <h6 className="pl-3 pr-2 p-1 target-key">{Object.keys(target)} :</h6>
            <h6 className="pl-2 pr-3 p-1target-val">{Object.values(target)}</h6>
          </div>
        ))}
      </div>
    </div>
